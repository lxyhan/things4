...
**YOU ARE IN: `things4/polecats/nitro/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/things4/` (rig root) or other directories
...
**Your mail address:** `things4/polecats/nitro`
**Your rig:** things4
**Your Witness:** `things4/witness`
...
| Ask Witness for help | `gt mail send things4/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`things4/witness`) when:
...
```bash
gt mail send things4/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
