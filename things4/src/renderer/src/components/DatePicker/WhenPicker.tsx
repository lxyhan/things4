...
export function WhenPicker({ value, onChange, onClose, anchorEl }: WhenPickerProps): React.JSX.Element {
  const today = getToday()
  ...
  const picker = (
    ...
    >
      <div className={styles.quickRow}>
        <button className={styles.quickBtn} onMouseDown={() => { onChange('today'); onClose() }}>
          <span className={styles.quickIcon}>★</span>
          <span>Today</span>
        </button>
        <button className={styles.quickBtn} onMouseDown={() => { onChange('evening'); onClose() }}>
          <span className={styles.quickIcon}>☽</span>
          <span>This Evening</span>
        </button>
        <button className={styles.quickBtn} onMouseDown={() => { onChange('someday'); onClose() }}>
          <span className={styles.quickIcon}>…</span>
          <span>Someday</span>
        </button>
      </div>
